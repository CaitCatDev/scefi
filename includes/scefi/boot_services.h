...
#include <scefi/device_path_protocol.h>
...
typedef EFI_STATUS (EFIAPI *EFI_CREATE_EVENT) (IN UINT32 Type, IN EFI_TPL NotifyTpl, IN EFI_EVENT_NOTIFY NotifyFunc, OPTIONAL IN VOID *NotifyContext, OPTIONAL OUT EFI_EVENT *Event);
...
typedef EFI_STATUS(EFIAPI *EFI_CLOSE_PROTOCOL)(IN EFI_HANDLE Hanlde, IN EFI_GUID *Protocol, IN EFI_HANDLE AgentHandle, IN EFI_HANDLE ControllerHandle);
...
typedef EFI_STATUS (EFIAPI *EFI_INSTALL_MULTIPLE_PROTOCOL_INTERFACE)(IN OUT EFI_HANDLE *Handle, ...);
typedef EFI_STATUS (EFIAPI *EFI_UNINSTALL_MULTIPLE_PROTOCOL_INTERFACE)(IN OUT EFI_HANDLE *Handle, ...);
...
typedef struct _EFI_BOOT_SERVICES {
	 ...
	 */
	EFI_CONNECT_CONTROLLER ConnectorController;
